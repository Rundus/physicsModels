...
from invertedV_fitting.simToggles_invertedVFitting import GenToggles
...
for timeIdx in range(len(EpochFitData)):
    ...
    kappa_fitParam = data_dict_beamFits['kappa'][0][secondaryBackScatterToggles.wPtchIdx][timeIdx]
